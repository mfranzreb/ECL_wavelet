...
nsys --output="./WT_construction_1G_4" --force-overwrite=true --trace=cuda,osrt ./build/benchmark/ecl_WT_profile 1000000000 4 0

nsys --output="./WT_construction_1G_150" --force-overwrite=true --trace=cuda,osrt ./build/benchmark/ecl_WT_profile 1000000000 150 0

nsys --output="./WT_construction_500M_20000" --force-overwrite=true --trace=cuda,osrt ./build/benchmark/ecl_WT_profile 500000000 20000 0