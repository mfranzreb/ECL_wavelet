...
nvprof --export-profile "./WT_construction_1G_4_vprof.prof" -f --trace api,gpu ./build/benchmark/ecl_WT_profile 1000000000 4 0

nvprof --export-profile "./WT_construction_1G_150_vprof.prof" -f --trace api,gpu ./build/benchmark/ecl_WT_profile 1000000000 150 0

nvprof --export-profile "./WT_construction_500M_20000_vprof.prof" -f --trace api,gpu ./build/benchmark/ecl_WT_profile 500000000 20000 0