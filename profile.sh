...
nvprof --profile-from-start off --export-profile "./RS_construction_200Mbitx5_vprof.prof" -f --trace api,gpu ./build/bitarray/benchmark/ecl_RS_profile 200000000 5

nvprof --profile-from-start off --export-profile "./RS_construction_500Mbitx10_vprof.prof" -f --trace api,gpu ./build/bitarray/benchmark/ecl_RS_profile 500000000 10