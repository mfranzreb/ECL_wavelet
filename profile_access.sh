...
nsys --capture-range=cudaProfilerApi --output="./access_1G_4_500000" --force-overwrite=true --trace=cuda,osrt ./build/benchmark/ecl_access_profile 1000000000 4 500000

nsys --capture-range=cudaProfilerApi --output="./access_1G_150_500000" --force-overwrite=true --trace=cuda,osrt ./build/benchmark/ecl_access_profile 1000000000 150 500000

nsys --capture-range=cudaProfilerApi --output="./access_500M_20000_500000" --force-overwrite=true --trace=cuda,osrt ./build/benchmark/ecl_access_profile 500000000 20000 500000